...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function addProductToTable(product) {
        ...
        tr.innerHTML = `<td>${product.product_id}</td><td>${product.name}</td><td>$${product.price}</td><td>${product.quantity}</td><td><button class="delete-button" data-id="${product.product_id}">Delete</button></td>`;
